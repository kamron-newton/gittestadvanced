...
echo "Finished running People test, uploading report to S3 `date +%T`" >> /home/ec2-user/testEngine/log.txt
...
echo "Finished running Delta test, uploading report to S3 `date +%T`" >> /home/ec2-user/testEngine/log.txt
