...
SUBJECT = f"Test report - {sys.argv[2]}"
...
try:
    ...
    response = client.send_raw_email(
        Source=SENDER,
        Destinations=recipients[sys.argv[1]],
        RawMessage={
            'Data':msg.as_string(),
        }
    )
# Display an error if something goes wrong.	
    ...
    print(f"From email address is {SENDER} and it is sent to {recipients[sys.argv[1]]}")