...
echo "Finished running Basic test, uploading report to S3 `date +%T`" >> /home/ec2-user/testEngine/log.txt
...
echo "Finished running CH test, uploading report to S3 `date +%T`" >> /home/ec2-user/testEngine/log.txt
...
echo "Finished running Newton test, uploading report to S3 `date +%T`" >> /home/ec2-user/testEngine/log.txt
...
echo "Finished running Synergy test, uploading report to S3 `date +%T`" >> /home/ec2-user/testEngine/log.txt
