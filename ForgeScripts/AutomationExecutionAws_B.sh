...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py People #{TenantCode}# #{FullReleaseVersion}# #{EnvironmentType}#
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Delta #{TenantCode}# #{FullReleaseVersion}# #{EnvironmentType}#
