...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py People #{TenantCode}#
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Delta #{TenantCode}#
