...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py CrimsonHawks #{TenantCode}# #{FullReleaseVersion}# #{EnvironmentType}# `date +"%m/%d/%Y"` `date +"%r"` `date +"%p"`
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Newton #{TenantCode}# #{FullReleaseVersion}# #{EnvironmentType}# `date +"%m/%d/%Y"` `date +"%r"` `date +"%p"`
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Synergy #{TenantCode}# #{FullReleaseVersion}# #{EnvironmentType}# `date +"%m/%d/%Y"` `date +"%r"` `date +"%p"`
