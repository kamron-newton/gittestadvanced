...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Basic #{TenantCode}#
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py CrimsonHawks #{TenantCode}#
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Newton #{TenantCode}#
...
sudo python3 /home/ec2-user/testEngine/codeDeploy/send_pdf_mail.py Synergy #{TenantCode}#
